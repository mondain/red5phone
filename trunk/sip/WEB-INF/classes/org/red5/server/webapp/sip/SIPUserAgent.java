...
public class SIPUserAgent extends CallListenerAdapter
{
   ...
   public SIPUserAgent(SipProvider sip_provider, SIPUserAgentProfile user_profile, SIPUserAgentListener listener, RTMPUser rtmpUser)
   ...
   protected void launchMediaApplication()
   {
      ...
      {  // create an audio_app and start it
         ...
         if (audio_app==null) {
           audio_app = new SIPAudioLauncher(local_audio_port, remote_media_address, remote_audio_port, rtmpUser, user_profile.audio_sample_rate, user_profile.audio_sample_size, user_profile.audio_frame_size);
         }
